...
async function finalQA() {
  ...
  await page.screenshot({ path: '.sisyphus/evidence/final/homepage-light.png', fullPage: true });
  ...
  await page.screenshot({ path: '.sisyphus/evidence/final/homepage-dark.png', fullPage: true });
  ...
  await page.emulateMedia({ colorScheme: 'dark' });
  await page.waitForLoadState('networkidle');
  await page.screenshot({ path: '.sisyphus/evidence/final/albums-dark.png', fullPage: true });
  ...
  await page.emulateMedia({ colorScheme: 'dark' });
  await page.waitForLoadState('networkidle');
  await page.screenshot({ path: '.sisyphus/evidence/final/login-dark.png', fullPage: true });
